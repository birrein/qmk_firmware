...
/*
Visual guide for MIRYOKU_LAYER_BASE / MIRYOKU_LAYER_TAP (Corne 3x6_3_ex2):
...
Tip: keep both BASE and TAP aligned when editing so position changes are easy to track.
*/
...
/* Home row */ \
CW_TOGG, LGUI_T(KC_A),    LALT_T(KC_S),    LCTL_T(KC_D),    LSFT_T(KC_F),         KC_G,                 KC_H,                LSFT_T(KC_J),        LCTL_T(KC_K),       LALT_T(KC_L),       LGUI_T(KC_SCLN),      KC_QUOT, \
/* Bottom row */ \
QK_REP,  LT(U_BUTTON,KC_Z), ALGR_T(KC_X),  KC_C,            KC_V,                 KC_B,                 KC_N,                KC_M,                KC_COMM,            ALGR_T(KC_DOT),     LT(U_BUTTON,KC_SLSH), KC_BSLS, \
/* Thumb + ex2 */ \
U_EXL1,  U_EXL2,          LT(U_MEDIA,KC_ESC), LT(U_NAV,KC_SPC), LT(U_MOUSE,KC_TAB), LT(U_SYM,KC_ENT),   LT(U_NUM,KC_BSPC),   LT(U_FUN,KC_DEL),    U_EXR1,             U_EXR2
...
/* Bottom row */ \
QK_REP,  KC_Z,            KC_X,            KC_C,            KC_V,                 KC_B,                 KC_N,                KC_M,                KC_COMM,            KC_DOT,             KC_SLSH,               KC_BSLS, \
/* Thumb + ex2 */ \
U_EXL1,  U_EXL2,          KC_ESC,          KC_SPC,          KC_TAB,               KC_ENT,               KC_BSPC,             KC_DEL,              U_EXR1,             U_EXR2
